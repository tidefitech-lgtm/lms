...
const isPaymentSupportPage = /payment|pending-approval/.test(
  window.location.pathname,
);
const message = encodeURIComponent(
  isPaymentSupportPage
    ? "Hello TIDEF ITECH, I need help with payment or payment verification for my LMS account."
...
if (!document.querySelector(".whatsapp-float")) {
  ...
  link.innerHTML = `
    ...
    <span class="whatsapp-float-label">${isPaymentSupportPage ? "Payment support on WhatsApp" : "Chat with TIDEF ITECH"}</span>
  `;
